...
include_once "funcoes.php";
  $row = 1;
  if (($handle = fopen("images/horarios.csv", "r")) !== FALSE) {
            ...
            <div class="offset-md-1 col-lg-3 col-md-5 mb-5 mb-md-5">
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled open-hours">                        
                       <?php
                        $row = '';
                        foreach ($h['takeaway'] as $key => $value) {
                            foreach ($value as $ke => $v) {
                                echo " <li class='d-flex'> <span>";
                                if ($row != $v['titulo'] ){
                                    $row = $v['titulo'];
...
<script src="js/jquery.min.js?version=<?= filectime("js/jquery.min.js"); ?>"></script>
<script src="js/jquery-migrate-3.0.1.min.js?version=<?= filectime("js/jquery-migrate-3.0.1.min.js"); ?>"></script>
<script src="js/popper.min.js?version=<?= filectime("js/popper.min.js"); ?>"></script>
<script src="js/bootstrap.min.js?version=<?= filectime("js/bootstrap.min.js"); ?>"></script>
<script src="js/jquery.easing.1.3.js?version=<?= filectime("js/jquery.easing.1.3.js"); ?>"></script>
<script src="js/jquery.waypoints.min.js?version=<?= filectime("js/jquery.waypoints.min.js"); ?>"></script>
<script src="js/jquery.stellar.min.js?version=<?= filectime("js/jquery.stellar.min.js"); ?>"></script>
<script src="js/owl.carousel.min.js?version=<?= filectime("js/owl.carousel.min.js"); ?>"></script>
<script src="js/jquery.magnific-popup.min.js?version=<?= filectime("js/jquery.magnific-popup.min.js"); ?>"></script>
<script src="js/aos.js?version=<?= filectime("js/aos.js"); ?>"></script>
<script src="js/jquery.animateNumber.min.js?version=<?= filectime("js/jquery.animateNumber.min.js"); ?>"></script>
<script src="js/bootstrap-datepicker.js?version=<?= filectime("js/bootstrap-datepicker.js"); ?>"></script>
<script src="js/jquery.timepicker.min.js?version=<?= filectime("js/jquery.timepicker.min.js"); ?>"></script>
<script src="js/scrollax.min.js?version=<?= filectime("js/scrollax.min.js"); ?>"></script>
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script> -->
<!-- <script src="js/google-map.js"></script> -->
<script src="js/main.js?version=<?= filectime("js/main.js"); ?>"></script>