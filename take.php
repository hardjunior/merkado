 ...
 include_once "funcoes.php";
    ...
    $regiao     = [];
    $all        = [];
    if (($handle = fopen("images/bd_take.csv", "r")) !== FALSE) {
...
<style>
.back-take{
    background: url('images/moisaicofundo.jpg') no-repeat fixed center;
...
@media (max-width: 769px) {
 ...
 <section class="ftco-menu mb-5 pb-5 back-take">
     <div class="container-fluid align-items-center text-center">
        <img src='images/logoTake-Away.png' id='logoTake-Away'>
     </div>
