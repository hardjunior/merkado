...
include_once "funcoes.php";
  $row = 1;
  if (($handle = fopen("../images/lagoa/horarios.csv", "r")) !== FALSE) {
            ...
            <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        ...
                        <li class="ftco-animate"><a href="https://www.facebook.com/merkado.nalagoa"><span class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="https://www.instagram.com/merkadonalagoa/"><span class="icon-instagram"></span></a></li>
                        <li class="ftco-animate"><a href='https://wa.me/351925576883'><span class="icon-whatsapp"></span></a></li>
            ...
            <div class="offset-md-1 col-lg-3 col-md-5 mb-5 mb-md-5 ">
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled open-hours">                        
                       <?php
                        $row = '';
                        foreach ($h['snack-bar'] as $key => $value) {
                            foreach ($value as $ke => $v) {
                                echo " <li class='d-flex'> <span>";
                                if ($row != $v['titulo'] ){
                                    $row = $v['titulo'];
...
<div class="container-fluid p-4">
        <div class="row">
            ...
            <div class="col-md-3 text-center">
                <a class="title btn-home" href="https://www.livroreclamacoes.pt/inicio?p_p_auth=UVPk59lu&amp;p_p_id=49&amp;p_p_lifecycle=1&amp;p_p_state=normal&amp;p_p_mode=view&amp;_49_struts_action=%2Fmy_sites%2Fview&amp;_49_groupId=20495&amp;_49_privateLayout=false" title="Ir para livroreclamacoes.pt"> <img alt="livroreclamacoes.pt" src="../images/lagoa/logo_livro_reclamacoes.png"> </a>
            </div>
...
<script src="lagoa/js/jquery.min.js?version=<?= filectime("js/jquery.min.js"); ?>"></script>
<script src="lagoa/js/jquery-migrate-3.0.1.min.js?version=<?= filectime("js/jquery-migrate-3.0.1.min.js"); ?>"></script>
<script src="lagoa/js/popper.min.js?version=<?= filectime("js/popper.min.js"); ?>"></script>
<script src="lagoa/js/bootstrap.min.js?version=<?= filectime("js/bootstrap.min.js"); ?>"></script>
<script src="lagoa/js/jquery.easing.1.3.js?version=<?= filectime("js/jquery.easing.1.3.js"); ?>"></script>
<script src="lagoa/js/jquery.waypoints.min.js?version=<?= filectime("js/jquery.waypoints.min.js"); ?>"></script>
<script src="lagoa/js/jquery.stellar.min.js?version=<?= filectime("js/jquery.stellar.min.js"); ?>"></script>
<script src="lagoa/js/owl.carousel.min.js?version=<?= filectime("js/owl.carousel.min.js"); ?>"></script>
<script src="lagoa/js/jquery.magnific-popup.min.js?version=<?= filectime("js/jquery.magnific-popup.min.js"); ?>"></script>
<script src="lagoa/js/aos.js?version=<?= filectime("js/aos.js"); ?>"></script>
<script src="lagoa/js/jquery.animateNumber.min.js?version=<?= filectime("js/jquery.animateNumber.min.js"); ?>"></script>
<script src="lagoa/js/bootstrap-datepicker.js?version=<?= filectime("js/bootstrap-datepicker.js"); ?>"></script>
<script src="lagoa/js/jquery.timepicker.min.js?version=<?= filectime("js/jquery.timepicker.min.js"); ?>"></script>
<script src="lagoa/js/scrollax.min.js?version=<?= filectime("js/scrollax.min.js"); ?>"></script>
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script> -->
<!-- <script src="js/google-map.js"></script> -->
<script src="lagoa/js/main.js?version=<?= filectime("js/main.js"); ?>"></script>