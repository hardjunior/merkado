 <?php
	...
	$row = 1;
	if (($handle = fopen("../images/lagoa/informacao.csv", "r")) !== FALSE) {
								...
								<div class='wrap d-md-flex align-items-xl-end'>
									<div class='info col-md-6' style='height:250px;'>
										...
										<div class='row '>
											...
											<a href='https://wa.me/351925576883'>
													+351 925576883
											</a>
										</div>
										<br>
										<div class='row '>
											...
											<a href='mailto:merkado.lagoa@outlook.pt'>
													merkado.lagoa@outlook.pt
												</a>
										</div>
										<br>
										<div class='row '>
